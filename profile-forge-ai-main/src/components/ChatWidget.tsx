  ...
  return (
    <>
      ...
      <Button
        ...
        size="icon"
        className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full gradient-primary shadow-xl hover:scale-110 active:scale-95 transition-all duration-200 group relative"
      >
      ...
      {/* Chat Window */}
      {open && (
        <div className="fixed bottom-24 right-6 w-[350px] max-w-[calc(100vw-3rem)] h-[500px] bg-white rounded-3xl shadow-2xl border border-border/50 overflow-hidden flex flex-col z-50">
          {/* Header */}
